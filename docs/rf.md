...
![Screenshot](img/cut_earthquakes.png)
...
![Screenshot](img/read_waveforms_RFs.png)
...
![Screenshot](img/Read_events_RF.png)
...
After the receiver functions have been computed and undergone a visual quality control, they can be saved using the ‘Save RFs’ feature ([43], Fig. 4). The resulting files can be loaded back into the program for the back-tracing and CCP stacking of the receiver functions.
...
![Screenshot](img/map_venezuela.png)

![Screenshot](img/ccp_stack.png)
